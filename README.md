...
(этот проект уже переделан под запуск из-под WSL 2 Ubuntu, если установлен Docker Desktop на хосте с Windows. Этот ip-адрес 172.17.0.1 больше нигде не используется)  

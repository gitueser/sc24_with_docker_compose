...
//    }
    ...
    @Bean
    @Order(0)
    public SecurityWebFilterChain actuatorHealthSecurityWebFilterChain(ServerHttpSecurity http) {
        return http
                .securityMatcher(pathMatchers("/actuator/health/**"))
    ...
    public SecurityWebFilterChain actuatorSecurityWebFilterChain(ServerHttpSecurity http) {
        return http
                .securityMatcher(pathMatchers("/actuator/**"))
                .authorizeExchange(ex -> ex.anyExchange().hasAuthority("SCOPE_metrics"))
